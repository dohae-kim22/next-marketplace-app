      ...
      <div className="flex items-center justify-center fixed bottom-0 right-0 w-full p-5 pb-9 bg-neutral-900">
        <form className="flex relative max-w-lg w-full" onSubmit={onSubmit}>
          <input
            ...
            onChange={onChange}
            value={message}
            className="bg-transparent rounded-full w-full h-10 focus:outline-none px-5 ring-2 focus:ring-3 transition ring-neutral-200 focus:ring-neutral-50 border-none placeholder:text-neutral-400"
            type="text"
            name="message"
